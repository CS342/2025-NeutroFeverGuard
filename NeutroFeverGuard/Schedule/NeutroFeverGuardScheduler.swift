    ...
    func configure() {
        do {
            ...
            try scheduler.createOrUpdateTask(
                ...
                schedule: .daily(hour: 17, minute: 35, startingAt: .today),
...
//                id: "enter-lab-result",
//                title: "Enter Lab Results",
//                instructions: "You haven't recorded your lab results for the last 7 days. Record now!",
//                category: .measurement,
//                schedule: .daily(hour: 16, minute: 40, startingAt: sevenDaysLater),
//                scheduleNotifications: true
//            )
        } catch {
