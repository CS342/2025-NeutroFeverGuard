...
class NeutroFeverGuardDelegate: SpeziAppDelegate {
    ...
    private var healthKit: HealthKit {
        HealthKit {
            CollectSample(HeartRateEntry.healthKitType)
            CollectSample(TemperatureEntry.healthKitType)
            CollectSample(OxygenSaturationEntry.healthKitType)
            CollectSample(BloodPressureEntry.systolicType)
            CollectSample(BloodPressureEntry.diastolicType)
        }
    }
}
